...
const messages = {
  ...
  en: {
    ...
    heroNoteCategoryTitle: "Explore by category",
    heroNoteCategoryBody:
      "Major tsParticles effects are grouped by use case and implementation style.",
    heroNoteTuneTitle: "Tune each demo",
...
const categoryText = {
  ja: {
    ...
    shapes: "circle, image, text, polygon など、粒子の shape type ごとの見え方を比較できます。",
    plugins: "emitters, absorbers, polygon mask, mouse interactions などの拡張表現を試せます。",
  ...
  en: {
    ...
    bundles:
      "Try minimal examples for focused APIs such as particles(), confetti(), and fireworks().",
  },
};
